...
{
    internal class NightOverScreen : Menu.Menu
    {
        private readonly SimpleButton continueButton;
        private readonly SimpleButton exitButton;

        private EndOfNightClock clock;

        private bool ButtonsGreyedOut => clock.Done; // 2 seconds
        ...
        public NightOverScreen(ProcessManager manager) : base(manager, Constants.NightOverScreen)
        {
